...
public class Application {
	...
	//Example 1
		...
		System.out.println("Does list1 have 12? " + list1.contains(12));

		// merge newList into list1
		list1.addAll(newList);

		System.out.println(list1);

		// remove elements appeared in newList from list1
		...
		// retain whatever is inside newList and remove other elements from list1
		...
		// sorting list with Collection.sort 
		Collections.sort(li);
